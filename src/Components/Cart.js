...
export default function Cart(props){
    return(
        ...
        <Button variant="primary"style={{backgroundColor:"#6c757d",border:"none"}}>
            <a href={props.pre} style={{textDecoration:"none",color:"white",marginLeft:"4px"}}> <Eye></Eye> Live Preview</a></Button>
        </div> 
        </Card.Body>
        </Card>
    </div>
